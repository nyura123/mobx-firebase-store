...
export default class Other extends React.Component {
  static async getInitialProps ({req}) {
    ...
    console.log('OTHER AWAIT INITIAL FIREBASE DATA...')
    await promise
    console.log('OTHER DONE AWAITING INITIAL FIREBASE DATA.')

    //Don't forget to unsubscribe - don't want to unsubscribe too early
    setTimeout(() => console.log('other initialUnsubscribe from firebase') || unsubscribe(), 1000)
